            ...
            <div class="post-content">
                ...
                <div class="post-excerpt-container">
                    @if(strlen($post->content) > 200)
                        <p class="post-excerpt" id="excerpt-{{ $post->id }}">
                            {{ Str::limit($post->content, 200) }}
                        </p>
                        <p class="post-full-content" id="full-{{ $post->id }}" style="display: none;">
                            {{ $post->content }}
                        </p>
                        <button class="see-more-btn" onclick="toggleContent({{ $post->id }})" id="toggle-{{ $post->id }}">
...
<script>
// Toggle content function for "See more" feature
